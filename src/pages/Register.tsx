    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-10 bg-gray-500 text-primary-foreground">
      <div className="w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border shadow-card p-6 space-y-3">
          ...
          <Field label="Password *" value={password} onChange={setPassword} type="password" placeholder="Minimal 8 karakter" showPasswordToggle />
          <Field label="Konfirmasi Password *" value={confirm} onChange={setConfirm} type="password" showPasswordToggle />
...
function Field({
  label, value, onChange, type = "text", placeholder, showPasswordToggle = false,
}: {
  label: string;
  value: string;
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full rounded-md border border-input bg-background text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-ring ${
